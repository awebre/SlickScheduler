...
namespace SlickScheduler.Controllers
{
    public class SemestersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SemesterId,SemesterNum")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SemesterId,SemesterNum")] Semester semester)
        {
            if (ModelState.IsValid)
            {
